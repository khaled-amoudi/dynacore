...
<div class="modal fade" tabindex="-1" id="kt_modal_multi_delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="fw-bold">{{ __('common.Are You Sure Of Deleting These Records ?') }}</p>
                <p class="mt-5"><span class="badge badge-light-danger">{{ __('common.NOTE:') }}</span>
                    {{ __('common.You will') }} <span class="border-bottom border-danger">{{ __('common.not be able') }}</span> {{ __('common.you will not be able to restore them.') }}</p>
            </div>
