                        ...
                        <div class="card-toolbar">
                            ...
                            @if (!isset($actions['route_force_delete']))
                                ...
                                @else
                                        ...
                                        @if (isset($actions['with_soft_delete']) && $actions['with_soft_delete'] == true)
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="kt_datatable_example_1" class="table table-striped table-row-bordered gy-5 gs-7">
                                ...
                                <tbody>
                                        ...
                                        <tr class="del_{{ $data['id'] }} {{ $loop->odd ? 'bg-accent' : '' }}">
                                            ...
                                            @if (isset($actions['with_delete_group']))
                                                <td>
                                                    <div
                                                        class="form-check form-check-sm form-check-custom form-check-solid">
                                                        <input name="deletegroup" value="{{ $data['id'] }}"
                                                            class="form-check-input deletegroup multiDeleteCheckbox widget-13-check"
                                                            type="checkbox">
                                                    </div>
                                                </td>
                                            @endif
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="{{ count($ths) + (isset($actions['with_delete_group']) ? 1 : 0) }}">
                                                @if (isset($actions['route_force_delete']))
